...
import { loginUser } from "../api/authApi"; // Uncomment for actual use
          ...
          <div className="bg-white/[0.02] backdrop-blur-3xl border border-white/10 rounded-[2.5rem] shadow-2xl p-10 flex flex-col gap-8 transition-all duration-500 hover:border-white/20">
            ...
            <div className="flex flex-col gap-2 text-center md:text-left">
              <h2 className="text-3xl font-extrabold tracking-tight text-black drop-shadow-sm">
                Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-emerald-400">Revica AI</span>
              </h2>
            ...
            <p className="text-center text-slate-500 text-sm">
              New here?{" "}
              <a href="/register" className="text-teal-400 font-bold hover:underline decoration-2 underline-offset-4 transition-all">
                Create an account
              </a>
            </p>
          </div>
